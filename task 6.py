...
my_count(start_num = int(input('Введи стартовое число для цикла: ')), stop_num = int(input('Введи условие для завершения цикла: ')))

my_cycle(my_list = list(input('Введи значения в лист, которые хочешь повторить: ').split(',')), iteration = int(input('Сколько раз повторить? ')))